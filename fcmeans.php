...
<h3> Info Data Pemohon Penilaian</h3>
  <div>

Info Data Pemohon Pilihan Penilaian: 
...
echo"<tr bgcolor='$color'>
				...
				<td  align='left'>$c5</td>
				<td align='center'>
<a href='?mnu=fcmeans&kd=$id_penilaian&pro=hapus&id=$id'><img src='ypathicon/hapus2.png' alt='hapus' 
...
<?php
$jd=$i+1;
$gab="<h3> Normalisasi Data Pemohon Penilaian</h3>
  <div>
Normalisasi Data Pemohon Penilaian: 
...
$gab1.="<table border='1'><tr><td><td>c1<td>c2<td>SUM</tr>";
for($i=0;$i<$jd;$i++){
	$no=$i+1;
	...
	$AR[$i]=$AR1[$i]+$AR2[$i];
		$gab1.="<tr><td>$no<td>$AR1[$i]<td>$AR2[$i]<td>$AR[$i]</tr>";
}
$gab1.="</table></div>";
echo $gab1;
...
$gab2.="<div><table border='1'><tr><td>No<td>c1<td>c2<td>SUM</tr>";
for($i=0;$i<$jd;$i++){
	$no=$i+1;
	$AS1[$i]=$AR1[$i]/$AR[$i];
	$AS2[$i]=$AR2[$i]/$AR[$i];
	$AS[$i]=$AS1[$i]+$AS2[$i];
		$gab2.="<tr><td>$no<td>$AS1[$i]<td>$AS2[$i]<td>$AS[$i]</tr>";
}
$gab2.="</table></div>";
...
for($i=0;$i<$jd;$i++){
	...
	$K[$i]="A";
	$B[$i]=0;
	if($C1[$i]>=$C2[$i]){$H[$i]=1;$K[$i]="A";$B[$i]=$C1[$i];}
	else{$H[$i]=2;$K[$i]="B";$B[$i]=$C2[$i];}
...
$gab6.="<tr><td>No<td>c1<td>c2<td>c1<sup>-1</sup><td>c2<sup>-1</sup><td>sum</td></tr>";
for($i=0;$i<$jd;$i++){
	$no=$i+1;
$gab6.="<tr><td>$no
<td>$T1[$i]<td>$T2[$i]
...
$gab7.="<tr><td>No<td>c1<td>c2<td>Cluster<td>Result</td></tr>";
for($i=0;$i<$jd;$i++){
